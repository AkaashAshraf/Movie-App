...
class WatchFinalResultsView extends StatelessWidget {
  const WatchFinalResultsView({super.key});
...
class _HorizontalResultCard extends StatelessWidget {
  final String title;
  final String genre;
  final String imageUrl;
  final VoidCallback onTap;

  const _HorizontalResultCard({
    required this.title,
    required this.genre,
